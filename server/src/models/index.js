...
import { SentMonthlySummary } from './SentMonthlySummary.js'
...
User.hasMany(SentMonthlySummary, { foreignKey: 'userId', onDelete: 'CASCADE' })
SentMonthlySummary.belongsTo(User, { foreignKey: 'userId' })

export { User, Transaction, Budget, Goal, GoalContribution, Subscription, SentMonthlySummary }
